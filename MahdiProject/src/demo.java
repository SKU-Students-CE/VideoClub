...
public class demo {
    ...
    public static void defaults() throws InvalidNumberCharacters, InvalidNumberLength, InvalidScore, InvalidYear {
        ...
        Customer cst1 = new Customer("alibad", "Ali", "Badiee", "1273465789", "09101234567");
        Customer cst2 = new Customer("mohammadbad", "Mohammad", "Badiee", "1281234572", "09111234567");
        Customer cst3 = new Customer("hamedbad", "Hamed", "Badiee", "1291234567", "09121234567");
        ClubManager clb = new ClubManager("rezabad", "Alireza", "Akbari", "1277654321", "09134567321");
        users.put(cst1, "1234");
        users.put(cst2, "1234");
        users.put(cst3, "1234");
        users.put(clb, "1234");
